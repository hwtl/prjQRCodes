...
public class BarcodeUtil {
    ...
    public static final int MIDDLE = 140 ;
     ...
     * 生成图片的默认宽度像素
     */
    private static final int DEFAULT_WIDTH = MIDDLE;

    /**
     * 生成图片的默认高度像素
     */
    private static final int DEFAULT_HEIGHT = MIDDLE;
     ...
     * @throws IOException
     */
    public static void writeToFile(BarcodeFormat format, String contents,int width, int height,File file) throws WriterException, IOException {
        if(!file.exists()){
            file.mkdirs();
        }
